    ...
    <footer>
      ...
      grid gap-[50px] md:grid-cols-2 md:place-items-center mb-[60px]">
        ...
        <div>
          ...
          className='flex items-center gap-[10px] mt-[30px] mb-[20px]'><HiOutlineMail /> walker0369@gmail.com</a>

          <a href="tel:+213791792707"
          className='flex items-center gap-[10px]'><BsFillTelephoneFill /> 1+773-587-5316</a>
        </div>
      ...
      <p className='text-center pb-[30px] px-[15px]'>Copyright &copy; {new Date().getFullYear()} All rights reserved to Luke Sterling</p>
    </footer>
  )
}
